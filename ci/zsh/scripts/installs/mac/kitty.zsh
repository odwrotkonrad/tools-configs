...
function install_kitty {
  #[what] 1. install kitty to /Applications
  curl -L https://sw.kovidgoyal.net/kitty/installer.sh | sh /dev/stdin \
      launch=n  #[what] -n do not launch right away

  #[what] 2. link binaries to standard PATH location
  sudo ln -fs "$kitty_app_contents/MacOS/kitten" "$prefix/bin/kitten"
  sudo ln -fs "$kitty_app_contents/MacOS/kitty" "$prefix/bin/kitty"

  #[what] 3. copy man pages to expected location (bin/../share/man)
