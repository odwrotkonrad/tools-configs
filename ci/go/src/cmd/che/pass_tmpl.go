...
// passTmpl renders each *.host.tpl in the effective set onto the host.
...
// '~/' -> root/HOME/. Port of fn-tpl-resolve-at-includes.
...
// tmplHeader: autogen comment by extension. Port of fn-tpl-header.
