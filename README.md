<!-- autogenerated using @gitlab.com/konradodwrot/cross-repo/prose/assets//repos/configs/templates/3-audience/README.md.ontoRepo.tpl?ref=v0.0.54 -->
...
```yaml
##[>] primary
agents: profiles/llm/base/che.yml
